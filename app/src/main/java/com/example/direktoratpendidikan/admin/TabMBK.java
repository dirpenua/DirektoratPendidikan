 ...
 */
public class TabMBK extends Fragment implements SearchView.OnQueryTextListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View  view =  inflater.inflate(R.layout.fragment_tab_mbk, container, false);

        progressBar = view.findViewById(R.id.prograss);
        recyclerView = view.findViewById(R.id.recyclerView);
        cari = view.findViewById(R.id.cari);
        cari.setQueryHint("Cari MBK...");
    ...
    public void fetchMBK (String type){
        apiInterface = ApiClient.getApiClient().create(ApiInterface.class);
        Call<List<RelawanMBK>> call = apiInterface.getListMBK(type);
        Log.e("tipe", type);
    ...
    public boolean onQueryTextChange(String newText) {
        ...
        apiInterface = ApiClient.getApiClient().create(ApiInterface.class);
        Call<Cari> call = apiInterface.searchMBK(newText, kategori);

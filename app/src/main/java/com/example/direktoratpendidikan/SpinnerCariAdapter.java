...
public class SpinnerCariAdapter extends BaseAdapter {
    private Context mContext;
    private List<String> mValuesList;

    public SpinnerCariAdapter(Context mContext, List<String> mValuesList) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        if (view == null || !view.getTag().toString().equals("NON_DROPDOWN")) {
            LayoutInflater inflater = LayoutInflater.from(mContext);
            view = inflater.inflate(R.layout.custom_spinner_toolbar_cari, parent, false);
